			...
			<div class="box">
				...
				<div class="box-content no-padding">
							...
							<div class="col-sm-3">
								...
								if (!empty($roles))
									  foreach ($roles as $rol){?>
									    <div class="checkbox">
											<label>
												<input type="checkbox" name="roles[]" <?php if (isset($user) &&  !empty ($user['roles']) && in_array($rol->roleName, $user['roles'])) echo "checked='checked'" ?> value="<?php echo $rol->ID?>">
					...
					<div style="width:100%;text-align:center;padding:10px">
						...
						<a href="#" onclick="window.location.href = 'users/index'">
							<button class="btn btn-primary btn-label-left" type="button">
								Cancelar
							</button>
						</a>
